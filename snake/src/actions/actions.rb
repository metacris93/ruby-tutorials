module Actions
	def self.move_snake(state)
		...
		# verificar que la siguiente casilla sea valida si no es valida termina el juego
	...
	def self.calc_next_position(state)
		...
		when Model::Direction::UP
			#decrementar fila
			#[(1,1), (0,1)]
			return Model::Coordinate.new(curr_position.row - 1, curr_position.col)
		when Model::Direction::RIGHT
			#incrementar col
			return Model::Coordinate.new(curr_position.row, curr_position.col + 1)
	...
	def self.position_is_valid?(state, position)
		# verificar que este en el tablero
